...
<div class="max-w-md md:max-w-5xl mx-auto min-h-screen">
    ...
    <main class="p-4 md:p-6">
        ...
        <form action="../../../backend/actions/save_customer_profile.php" method="POST" enctype="multipart/form-data"
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="address" rows="3" class="w-full border rounded-xl p-3" required><?php echo e($user['address']); ?></textarea>
            </div>

            <?php if (!empty($user['profile_picture'])): ?>
                <div>
                    <p class="text-sm font-semibold mb-2">Current Profile Picture</p>
                    <img src="<?php echo BASE_URL . e($user['profile_picture']); ?>" class="w-24 h-24 object-cover rounded-xl border">
                </div>
            <?php endif; ?>
...
<nav class="fixed bottom-0 left-0 right-0 bg-white border-t shadow md:static md:shadow-none md:border md:rounded-2xl md:mt-6">
    <div class="max-w-md md:max-w-5xl mx-auto grid grid-cols-5 text-center text-xs">
        ...
        <a href="profile.php" class="py-3 text-blue-700 font-bold">Profile</a>
    </div>
</nav>
