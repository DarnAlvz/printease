...
ownerLayoutStart('status', 'Update Shop Status', 'Control whether customers can place orders with your print shop.', $notif_count, $shop);
?>
...
<div class="content-grid">
    <section class="owner-card">
        ...
        <form action="../../../backend/actions/update_shop_status.php" method="POST" class="form-grid" style="margin-top:20px;">
            ...
            <div class="field full">
                <button type="submit" name="update_status" class="btn btn-primary"><?php echo ownerIcon('refresh-cw', 'icon'); ?>Update Status</button>
            </div>
        </form>
    </section>
