...
<form action="../../../backend/actions/save_shop_profile.php" method="POST" enctype="multipart/form-data" class="shop-management-form">
    <div class="shop-management-grid">
        <section class="owner-card shop-profile-card">
            ...
            <div class="shop-logo-upload-row">
                ...
                <div class="shop-logo-actions">
                    <label for="shop_logo" class="btn btn-navy upload-logo-btn">
                        <?php echo ownerIcon('upload', 'icon'); ?>
                        Upload Logo
                    </label>
                    <input id="shop_logo" class="file-input-hidden" type="file" name="shop_logo" accept=".jpg,.jpeg,.png,.webp,.jfif,image/jpeg,image/png,image/webp">
            ...
            <div class="shop-location-block">
                ...
                <button type="button" class="location-map-button">Set Location on Map</button>
        ...
        <div class="shop-management-side">
            <section class="owner-card shop-details-card">
                <div class="card-head">
                    <h2>Shop Details</h2>
                    <span class="status-badge status-info"><?php echo ownerIcon('edit-3', 'icon-sm'); ?> Editable</span>
                </div>

                <div class="shop-details-fields">
                    <div class="field full">
                        <label for="shop_name">Shop Name</label>
                        <input id="shop_name" type="text" name="shop_name" value="<?php echo e($shop['shop_name'] ?? ''); ?>" placeholder="Shop Name" required>
                    </div>

                    <div class="field full">
                        <label for="shop_address">Address</label>
                        <textarea id="shop_address" name="shop_address" placeholder="Shop Address" required><?php echo e($shop['shop_address'] ?? ''); ?></textarea>
                    </div>

                    <div class="field full">
                        <label for="contact_number">Phone</label>
                        <input id="contact_number" type="text" name="contact_number" value="<?php echo e($shop['contact_number'] ?? ''); ?>" placeholder="+63 912 345 6789" required>
                    </div>

                    <div class="field full">
                        <label for="shop_status">Shop Status</label>
                        <select id="shop_status" name="shop_status" required>
                    ...
                    <div class="field full">
                        ...
                        <input id="business_permit_file" type="file" name="business_permit_file">
                        <?php if (!empty($shop['business_permit_file'])): ?>
